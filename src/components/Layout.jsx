...
import { LayoutDashboard, Upload, Package, Plus, History, Menu, X, CalendarCheck, Store, LineChart, Box, FileClock, LogIn, CheckCircle, LogOut, User, Undo2, Truck as TruckOff, Inbox } from 'lucide-react';
...
const adminMenu = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Inbox, label: 'Stok Produk', path: '/product-stock' }, // Menu baru ditambahkan di sini
