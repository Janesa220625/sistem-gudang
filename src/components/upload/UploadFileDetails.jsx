      ...
      <CardContent className="p-8">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
          ...
          <div className="flex gap-4 pt-4">
            <Button onClick={onProcess} disabled={processing || !account} className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 flex-grow">
