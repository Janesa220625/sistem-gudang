...
import { Truck as TruckOff, Info, Upload, Download, FileSpreadsheet } from 'lucide-react';
    ...
    reader.onload = async (e) => {
      try {
        ...
        toast({
          ...
          description: `${orderSnList.length} pesanan telah ditandai sebagai 'Gagal Kirim'.`,
        });
        resetState();
      } catch (error) {
                    ...
                    {file ? (
                        <div className="space-y-4 text-center">
                            ...
                            <Button onClick={processFile} disabled={processing} className="w-full bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700">
                                <TruckOff className="mr-2 h-4 w-4" />
