...
function OrderHistory() {
  ...
  const filteredOrders = useMemo(() => {
    ...
    if (accountFilter !== "all") {
      filtered = filtered.filter(
        (order) => order.storeAccountName === accountFilter
      );
    }
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-400 text-lg">
          Kelola dan pantau semua pesanan yang telah diterima
        </p>
      </motion.div>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Tindakan ini akan menghapus pesanan secara
                                    permanen. Data tidak bisa dikembalikan.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
